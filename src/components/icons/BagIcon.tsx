...
const BagIcon: React.FC<IconProps> = ({color = 'currentColor'}) => {
  return (
    <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <path
        d="M6.66666 8.33341V5.00008C6.66666 4.11603 7.01785 3.26818 7.64297 2.64306C8.2681 2.01794 9.11594 1.66675 10 1.66675C10.8841 1.66675 11.7319 2.01794 12.357 2.64306C12.9821 3.26818 13.3333 4.11603 13.3333 5.00008V8.07425"
        stroke={color} stroke-linecap="round" stroke-linejoin="round"/>
    </svg>
  );
};
